...
void SandboxLayer::OnAttach()
{
	...
	m_Shader.push_back(Shader::FromGLSLTextFiles(
		"assets/shaders/5.1.transform.vert.glsl",
		"assets/shaders/5.1.transform.frag.glsl"
	));
...
void SandboxLayer::OnUpdate(Timestep ts)
{
	...
	transform2 = glm::scale(transform2, glm::vec3(1.0f, 1.0f, 1.0f)*sin((float)glfwGetTime()));

	// get matrix's uniform location and set matrix
	m_Shader[0]->use();
	unsigned int transformLoc = glGetUniformLocation(m_Shader[0]->GetRendererID(), "transform");
