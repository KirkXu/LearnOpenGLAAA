...
void SandboxLayer::OnUpdate(Timestep ts)
{
	...
	view                 = glm::translate(view, glm::vec3(m_ViewX, m_ViewY, m_ViewZ));
...
void SandboxLayer::OnImGuiRender()
{
	...
	// set view matrix
	ImGui::Text(" ");
	ImGui::Text("Set View Matrix: ");
	ImGui::SliderFloat("viewX: ", &m_ViewX, -10.f, 10.0f);
	ImGui::SliderFloat("viewY: ", &m_ViewY, -10.f, 10.0f);
	ImGui::SliderFloat("viewZ: ", &m_ViewZ, -10.f, 10.0f);
