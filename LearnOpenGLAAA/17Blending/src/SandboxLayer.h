...
private:
	...
	GLuint m_CubeVAO, m_LightCubeVAO, m_PlaneVAO, m_TransparentVAO;
	GLuint m_CubeVBO, m_PlaneVBO, m_TransparentVBO;
	...
	std::shared_ptr<GLCore::Utils::Texture> m_TransparentTex;
