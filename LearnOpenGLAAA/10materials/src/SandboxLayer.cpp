...
void SandboxLayer::OnAttach()
{
	...
	m_Shader.push_back(Shader::FromGLSLTextFiles(
		"assets/shaders/10.1.materials.vs.glsl",
		"assets/shaders/10.1.materials.fs.glsl"
	));
	m_Shader.push_back(Shader::FromGLSLTextFiles(
...
void SandboxLayer::OnUpdate(Timestep ts)
{
	...
	m_Shader[0]->setVec3("material.diffuse", 0.07568, 0.61424, 0.07568);
	m_Shader[0]->setVec3("material.specular", 0.633, 0.727811, 0.633);
	m_Shader[0]->setFloat("material.shininess", 0.6);
